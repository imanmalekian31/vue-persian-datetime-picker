(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VuePersianDatetimePicker"] = factory();
	else
		root["VuePersianDatetimePicker"] = factory();
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"271738ee-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./src/VuePersianDatetimePicker.vue?vue&type=template&id=0d703d54&
...
/* harmony default export */ var VuePersianDatetimePickervue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    prevYearDisabled: function prevYearDisabled() {
      return this.hasStep('d') && this.minDate && this.minDate.clone().startOf('year') >= this.date.clone().startOf('year');
    },
    nextYearDisabled: function nextYearDisabled() {
      return this.hasStep('d') && this.maxDate && this.maxDate.clone().startOf('year') <= this.date.clone().startOf('year');
    },
  ...
  methods: {
    ...
    showToday: function showToday() {
      var currYear = this.core.dayjs().get('y');
      var currMonth = this.core.dayjs().get('M');
      this.date = this.date.clone().set('y', currYear).set('M', currMonth);
    },
